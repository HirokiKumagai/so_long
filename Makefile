...
SRCS := $(addprefix $(SRCS_DIR/), main.c load_map.c check_valid_map.c check_valid_map_utils.c is_valid_path.c is_valid_path_utils.c fill_in_map.c display_to_window.c move_player.c event_hook.c errors.c)
